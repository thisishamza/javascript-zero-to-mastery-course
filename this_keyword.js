...
const user1={
    ...
    // about detailed method can also be declared like this:
    aboutDetailed(hobby, favMusician) {  // so this also a method which is inside a object just like the above method
        console.log(this.firstname, this.age);
    }
